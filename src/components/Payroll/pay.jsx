    ...
    return (
        <StlyedBenefits>
            ...
            <div className='text-content'>
                 <h2>You Did It, Abdulazeez!</h2>
                 <p>
                     Rovendena will debit <span className='top'>₦5,101,550.00</span> from your company's account on <span className='top'>November 25,
